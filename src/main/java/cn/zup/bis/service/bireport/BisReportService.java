...
@Service
@Scope("prototype")
public class BisReportService extends BaseCompService {
		...
		if(!ps.isEmpty()){
			if(release == 0){
				...
				for(int i=0; i<params.size(); i++){
					...
					com.ruisi.ext.engine.view.context.form.InputField input = null;
					com.ruisi.ext.engine.view.context.form.InputField input2 = null;
					if("frd".equalsIgnoreCase(type) || "year".equalsIgnoreCase(type) || "quarter".equalsIgnoreCase(type)){
						com.ruisi.ext.engine.view.context.form.MultiSelectContextImpl target = new com.ruisi.ext.engine.view.context.form.MultiSelectContextImpl();
						...
						com.ruisi.ext.engine.view.context.form.DateSelectContext target = new com.ruisi.ext.engine.view.context.form.DateSelectContextImpl();
						...
						//创建第二个参数
						com.ruisi.ext.engine.view.context.form.DateSelectContext target2 = new com.ruisi.ext.engine.view.context.form.DateSelectContextImpl();
						...
						com.ruisi.ext.engine.view.context.form.SelectContextImpl target = new com.ruisi.ext.engine.view.context.form.SelectContextImpl();
						...
						//创建第二个参数
						com.ruisi.ext.engine.view.context.form.SelectContextImpl target2 = new com.ruisi.ext.engine.view.context.form.SelectContextImpl();
				...
				ButtonContext btn = new com.ruisi.ext.engine.view.context.form.ButtonContextImpl();
				btn.setDesc("查询");
				btn.setType("button");
